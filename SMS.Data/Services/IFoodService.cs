...
namespace SMS.Data.Services
{
    ...
    public interface IFoodService
    {
        ...
        Recipe CreateRecipe(int userId, string name, Diet diet, MealType mealType, string method, int prepTime, int cookTime, string cuisine, string region, string translator, int calories, int servings, string photoUrl);
