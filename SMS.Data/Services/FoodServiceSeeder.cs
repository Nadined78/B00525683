...
namespace SMS.Data.Services
{
    public static class FoodServiceSeeder
    {
        ...
        public static void Seed(IFoodService svc)
        {
            ...
            // register pasta
            var u1 = svc.Register("Pasta", "pasta@mail.com", "pasta123", Role.member, DateTime.Now,"Italian",  "https://tse3.mm.bing.net/th?id=OIP.HIBwLtEXMnop_y4pGUVbQwHaLH&pid=Api&P=0&w=109&h=163" );
            ...
            var u2 = svc.Register("Pizza", "pizza@mail.com", "pizza123", Role.member, DateTime.Now, "Italian", "https://tse3.mm.bing.net/th?id=OIP.Gi-aQfdYcOTWE_x7zGz7YQHaI2&pid=Api&P=0");
            ...
            var u3 = svc.Register("Curry", "curry@mail.com", "curry123", Role.member, DateTime.Now, "Indian", "" );
            ...
            var u4 = svc.Register("Soup", "Soup@mail.com", "soup123", Role.member, DateTime.Now, "French", "https://tse3.mm.bing.net/th?id=OIP.jFCaOstaToQH90hXktCBGAAAAA&pid=Api&P=0" );
            ...
            var u5 = svc.Register("Thai", "thai@mail.com", "thai123", Role.member, DateTime.Now, "Ethnic Thai" , "https://tse2.mm.bing.net/th?id=OIP.TN83udI5uc5Gvhvc8gSyoAHaLd&pid=Api&P=0" );
            ...
            var u6 = svc.Register("Stock", "stock@mail.com", "stock123", Role.member, DateTime.Now, "Irish" ,"" );
            ...
            var u7 = svc.Register("balsamic", "balsamic@mail.com", "balsamic123", Role.member, DateTime.Now,"French", "" );


            var u8 = svc.Register("Taco", "taco@mail.com", "taco123", Role.member, DateTime.Now, "Mexician", "" );
            var u9 = svc.Register("Breadstick", "breadstick@mail.com", "breadstick123", Role.member, DateTime.Now, "French", "" );
            var u10 = svc.Register("Hummus", "hummus@mail.com", "hummus123", Role.member, DateTime.Now, "Morrocan", "" );
            var u11 = svc.Register("Pepperoni", "pepperoni@mail.com", "pepperoni123", Role.member, DateTime.Now, "Italian", "" );
            var u12 = svc.Register("Burger", "burger@mail.com", "burger123", Role.member, DateTime.Now, "American", "");
            var u13 = svc.Register("Hotdog", "hotdog@mail.com", "hotdog123", Role.member, DateTime.Now, "American" , "" );
            var u14 = svc.Register("Spaghetti", "spaghetti@mail.com", "spaghetti123", Role.member, DateTime.Now, "Italian", "" );
            var u15 = svc.Register("Seabass", "seabass@mail.com", "seabass123", Role.member, DateTime.Now, "Spanish", "" );
            var u16 = svc.Register("Chicken", "chicken@mail.com", "chicken123", Role.member, DateTime.Now, "Scottish", "" );
            var u17 = svc.Register("Beef", "beef@mail.com", "beef123", Role.member, DateTime.Now, "Portuguese", "");
            var u18 = svc.Register("Fish", "fish@mail.com", "fish123", Role.member, DateTime.Now, "Greek", "" );
            var u19 = svc.Register("Pepper", "pepper@mail.com", "pepper123", Role.member, DateTime.Now, "German", "" );
            var u20 = svc.Register("Onion", "onion@mail.com", "onion123", Role.member, DateTime.Now, "English", "" );
           
            //Register an administrator 
            var u21 = svc.Register("Admin", "admin@mail.com", "admin", Role.admin, DateTime.Now, "Spanish", "");
