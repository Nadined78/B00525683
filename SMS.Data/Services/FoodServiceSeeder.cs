...
namespace SMS.Data.Services
{
    public static class FoodServiceSeeder
    {
        ...
        public static void Seed(IFoodService svc)
        {
            ...
            var u4 = svc.AddUser("Soup", "Soup@mail.com", "soup123", Role.member,  "French", "https://tse3.mm.bing.net/th?id=OIP.jFCaOstaToQH90hXktCBGAAAAA&pid=Api&P=0" );
            ...
            var u5 = svc.AddUser("Thai", "thai@mail.com", "thai123", Role.member, "Ethnic Thai" , "https://tse2.mm.bing.net/th?id=OIP.TN83udI5uc5Gvhvc8gSyoAHaLd&pid=Api&P=0" );
